    ...
    <div class="ace-settings-container" id="ace-settings-container">
        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <form class="form-horizontal" id="form" method="post" action="<?php echo U('editMenu');?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <select id="style_id" name="style_id" class="rcol-xs-10 col-sm-5">
                          <?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- 震哥版 -->
                                <!-- <option value="<?php echo ($v['id']); ?>" 
                                <?php if($v["id"] == $cook_style_def['id']): endif; ?>><?php echo ($v['style_name']); ?></option>     -->  

                                <!-- 2017-9-4 改 -->
                                <?php if($v["id"] == $cook_style_def['id']): ?><option value="<?php echo ($v['id']); ?>" selected="selected"><?php echo ($cook_style_def['style_name']); ?></option>
                                <?php else: ?> <option value="<?php echo ($v['id']); ?>"><?php echo ($v['style_name']); ?></option><?php endif; ?>

                                <!-- 原版 -->
                                <!-- <option value="<?php echo ($val['id']); ?>"><?php echo ($val['style_name']); ?></option> --><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <?php if($var["picture"] != ''): ?><div class="col-xs-10 col-sm-5"><img src="<?php echo ($var["picture"]); ?>" height="100" width="100" /></div>
                      <input type="hidden" name="picture_o" value="<?php echo ($var["picture"]); ?>"><?php endif; ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea name="introduce" id="tips" placeholder="" class="col-xs-10 col-sm-5" rows="5"><?php echo ($var["introduce"]); ?></textarea>
                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
                    </span>
                  </div>
